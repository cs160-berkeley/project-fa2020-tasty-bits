...
async function check(input) {
  ...
  // if the cache is empty (can be expired, or uses a different version):
...
describe('check', () => {
  ...
  it.skip('should work with our production endpoint and wait for result', async () => {
    ...
    assert.deepStrictEqual('https://github.com/prisma/@prisma/cli', coutput.current_download_url);
    // assert.deepStrictEqual(1576158940, coutput.current_release_date)
    assert.deepStrictEqual('https://github.com/prisma/@prisma/cli', coutput.current_changelog_url);
