...
Possible binaryTargets: ${chalk_1.default.greenBright(exports.knownBinaryTargets.join(', '))}`);
    ...
    ${chalk_1.default.greenBright(engine_core_1.printGeneratorConfig(Object.assign(Object.assign({}, generator), { binaryTargets: engine_core_1.fixBinaryTargets(generator.binaryTargets, platform) })))}
